...
const Coursesonline:React.FC = () => {
    return (
        <div className='bg-[#0c1e2f]  p-2' >
              <div className="text-center font-extrabold text-2xl text-white">
        <h1>Expand your <span className="text-blue-600 font-bold">Opportunity</span></h1>
      
        <h1>opportunity with our courses  </h1>
      </div>
