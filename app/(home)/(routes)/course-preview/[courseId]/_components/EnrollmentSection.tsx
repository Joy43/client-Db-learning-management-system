...
{userCourse?.courseId?
<div>
<h2>Learn and continue build project</h2>
      <button 
      className="p-2 rounded-lg w-full text-center bg-purple-500 mb-2 hover:bg-black">Continue</button>
</div>:null
}
       ...
       :!userCourse?.courseId? 
        <div className="grid gap-2">
          <div className="shadow-md bg-[#262e75] rounded-md p-2">
            ...
            <button className="p-2 rounded-lg w-full text-center bg-purple-500 mt-2 hover:bg-black">1.5/month</button>
          </div>
          <div className="shadow-md bg-[#262e75] rounded-md p-2 hover:bg-black">
            <h2>Buy Yearly offer Everything can be accessed</h2>
            <button className="p-2 rounded-lg w-full text-center bg-purple-500 mt-2 hover:bg-black">4.5/year</button>
          </div>
          <div className="shadow-md bg-[#262e75] rounded-md p-2">
            <h2>Buy Membership Everything can be accessed</h2>
            <button className="p-2 rounded-lg w-full text-center bg-purple-500 hover:bg-black mt-2">Membership 4.5/month</button>
          </div>
        </div>:null
      }
