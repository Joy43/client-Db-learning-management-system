    ...
    return (
      <div className="flex h-screen items-center justify-center bg-[#8EA7E9]/20 p-6 md:p-0">
        <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md md:h-[90%] md:w-[80%] lg:h-[80%]">
          ...
          <div className="relative hidden h-full items-center text-white justify-center bg-[#0b1739] md:flex md:w-[60%] lg:w-[40%]">
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="animate-pulse text-sm ">Please Enter Your Information</p>
            </div>
          </div>
          {/*------------- input side ----------------------------- */}
